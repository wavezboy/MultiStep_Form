      ...
      <FormContainer>
        <div className="lg:p-7 lg:h-screen  ">
          <div className="bg-white lg:w-[600px] w-[310px] h-[400px] lg:h-full  mt-[-90px] lg:mt-0 lg:mx-0 mx-auto p-7 lg:p-0 lg:rounded-none rounded-[10px]">
            <div>
              <p className="lg:text-[250%] text-[20px] mb-2 font-bold text-blue-950">
                {/* 500% = 36px */}
                Personal info
              </p>
              <h2 className="text-gray-400 lg:text-[100%] text-[15px] lg:mb-10 mb-3">
            ...
            >
              ...
              <div className=" lg:flex lg:justify-end pr-5 lg:pr-0 lg:h-0  w-full  lg:py-0 py-4  absolute right-0 bottom-0 lg:static lg:mr-0  ">
                <button
                  type="submit"
